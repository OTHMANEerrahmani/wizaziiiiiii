...
# Charger les données
df = pd.read_excel("802970 ready to use data.xlsx")
...
# Ajouter colonne pour seuils visuels
forecast_df['Zone critique'] = forecast_df['Predicted EGT Margin'].apply(
    lambda x: x if 12 < x < 18 else None
)
